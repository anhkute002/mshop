...
public class AddAddressActivity extends AppCompatActivity {
    ...
    EditText name, address,city,portalCode,phoneNumber;
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        portalCode = findViewById(R.id.ad_code);
        ...
        addAddressBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String userCode = portalCode.getText().toString();
                ...
                if(!userName.isEmpty()&& !userCity.isEmpty()&&!userAddress.isEmpty()&&!userCode.isEmpty()&&!userNumber.isEmpty()){
                    ...
                    Toast.makeText(AddAddressActivity.this,"kind fill all field",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
